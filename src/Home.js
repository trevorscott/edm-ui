...
class Home extends Component {
  ...
  produceMessage(e) {
    ...
    // format message
    const msg = this.formatMessage(e.target.id);
    // send message
    fetch(`${API_ROOT}/produceMessage`, {
      method: "POST",
      ...
      <div>
        <header>
          ...
          <div className="masthead-elements-row-2">
            <div className="element-middle">
              <button id="browse-kits" onClick={this.produceMessage} className="btn btn-default" href="#">Browse Kits</button>
              <button id="browse-products" onClick={this.produceMessage} className="btn btn-trans" href="#">Browse Products</button>
            </div>
          </div>
        </header>
        <section className="textured-section">
          ...
          <ul className="products">
            <li>
              ...
              <div className="product-button"><button id="areopress-coffee-maker" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="product-button"><button id="msr-reactor-2.5l-stove-system" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="product-button"><button id="bunum-wo-aa,-papua-new-guinea" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="product-button"><button id="chemex-classic-6-cup-coffee-maker" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
          </ul>
        </section>
        <section>
          ...
          <ul className="kits">
            <li>
              ...
              <div className="kit-button"><button id="the-chemex-kit" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="kit-button"><button id="the-pour-over-kit" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="kit-button"><button id="the-camper's-kit" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="kit-button"><button id="the-french-press-kit" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
            <li>
              ...
              <div className="kit-button"><button id="the-cold-brew-kit" onClick={this.produceMessage} className="btn btn-hot" href="#">Add to Cart</button></div>
            </li>
          </ul>
        </section>
        <footer>
          ...
          <div className="trailer-links">
            <ul className="internal-links">
              <li><span href="#" id="about" onClick={this.produceMessage}>About</span></li>
              <li><span href="#" id="support" onClick={this.produceMessage}>Support</span></li>
              <li><span href="#" id="contact-us" onClick={this.produceMessage}>Contact Us</span></li>
            </ul>
            <ul className="social-links">
              <li><span id="twitter" href="#" onClick={this.produceMessage}>
              ...
              <li><span id="facebook" href="#" onClick={this.produceMessage}>
              ...
              <li><span id="instagram" href="#" onClick={this.produceMessage}>
